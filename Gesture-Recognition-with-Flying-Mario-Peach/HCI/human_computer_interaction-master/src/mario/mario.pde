...
void draw() {  
  ...
  if(didUserChooseMovementDetectorType==false){
    background(255, 205, 107);
    textSize(30);
    fill(59, 62, 153);
    text("PRESS '1' FOR FIST MODE WITH FLYING MARIO",200,100); 
    text("PRESS '2' FOR PALM MODE WITH FLYING MARIO",200,160);
    text("PRESS '3' FOR FIST MODE WITH FLYING PEACH",200,220);
    text("PRESS '4' FOR PALM MODE WITH FLYING PEACH",200,280);
  }

  if ((userChoiseForMovementDetectorType == 1 || userChoiseForMovementDetectorType == 2 || userChoiseForMovementDetectorType == 3 || userChoiseForMovementDetectorType == 4 )&& didUserChooseMovementDetectorType == false) { 
  ...
  if(isHandMovementDetectorWindowCreated == false && didUserChooseMovementDetectorType ==true ) {
    background(59, 62, 153);
    textSize(32);
    fill(255, 205, 107);
    text("Please wait while the game is loading...", 275, 100); 
  }
  if (gameOver == false && isHandMovementDetectorWindowCreated == true && didUserChooseMovementDetectorType == true) {
    ...
    if((round(currentTime/1000))%15==0){
    if(temp!=(round(currentTime/1000))){
      temp=(round(currentTime/1000));
      level1=level1+1;
    }
    }
    text("Level: "+ level1, 950, 50);
  }
  
}

void checkGameOver() {
  if (((0<=randomHolePosition[0] && randomHolePosition[0]<=110) &  yPos > 455) || ((0<=randomHolePosition[1] && randomHolePosition[1]<=110) &  yPos > 455) || ((0<=randomHolePosition[2] && randomHolePosition[2]<=110) &  yPos > 455) || ((0<=randomHolePosition[3] && randomHolePosition[3]<=110) &  yPos > 455) || ((0<=randomHolePosition[4] && randomHolePosition[4]<=110) &  yPos > 455) || ((0<=randomHolePosition[5] && randomHolePosition[5]<=110) &  yPos > 455) || ((0<=randomHolePosition[6] && randomHolePosition[6]<=110) &  yPos > 455) || ((0<=randomHolePosition[7] && randomHolePosition[7]<=110) &  yPos > 455) || ((0<=randomHolePosition[8] && randomHolePosition[8]<=110) &  yPos > 455) || ((0<=randomHolePosition[9] && randomHolePosition[9]<=110) &  yPos > 455) || ((0<=randomHolePosition[10] && randomHolePosition[10]<=110) &  yPos > 455) || ((0<=randomHolePosition[11] && randomHolePosition[11]<=110) &  yPos > 455) || ((0<=randomHolePosition[12] && randomHolePosition[12]<=110) &  yPos > 455) || ((0<=randomHolePosition[13] && randomHolePosition[13]<=110) &  yPos > 455) || ((0<=randomHolePosition[14] && randomHolePosition[14]<=110) &  yPos > 455) || ((0<=randomHolePosition[15] && randomHolePosition[15]<=110) &  yPos > 455) || ((0<=randomHolePosition[16] && randomHolePosition[16]<=110) &  yPos > 455) || ((0<=randomHolePosition[17] && randomHolePosition[17]<=110) &  yPos > 455) || ((0<=randomHolePosition[18] && randomHolePosition[18]<=110) &  yPos > 455) || ((0<=randomHolePosition[19] && randomHolePosition[19]<=110) &  yPos > 455) || ((0<=randomHolePosition[20] && randomHolePosition[20]<=110) &  yPos > 455) || ((0<=randomHolePosition[21] && randomHolePosition[21]<=110) &  yPos > 455) || ((0<=randomHolePosition[22] && randomHolePosition[22]<=110) &  yPos > 455) || ((0<=randomHolePosition[23] && randomHolePosition[23]<=110) &  yPos > 455) || ((0<=randomHolePosition[24] && randomHolePosition[24]<=110) &  yPos > 455) || ((0<=randomHolePosition[25] && randomHolePosition[25]<=110) &  yPos > 455) || ((0<=randomHolePosition[26] && randomHolePosition[26]<=110) &  yPos > 455) || ((0<=randomHolePosition[27] && randomHolePosition[27]<=110) &  yPos > 455) || ((0<=randomHolePosition[28] && randomHolePosition[28]<=110) &  yPos > 455) || ((0<=randomHolePosition[29] && randomHolePosition[29]<=110) &  yPos > 455) || ((0<=randomHolePosition[30] && randomHolePosition[30]<=110) &  yPos > 455) || ((0<=randomHolePosition[31] && randomHolePosition[31]<=110) &  yPos > 455) || ((0<=randomHolePosition[32] && randomHolePosition[32]<=110) &  yPos > 455) || ((0<=randomHolePosition[33] && randomHolePosition[33]<=110) &  yPos > 455) || ((0<=randomHolePosition[34] && randomHolePosition[34]<=110) &  yPos > 455) || ((0<=randomHolePosition[35] && randomHolePosition[35]<=110) &  yPos > 455) || ((0<=randomHolePosition[36] && randomHolePosition[36]<=110) &  yPos > 455) || ((0<=randomHolePosition[37] && randomHolePosition[37]<=110) &  yPos > 455) || ((0<=randomHolePosition[38] && randomHolePosition[38]<=110) &  yPos > 455) || ((0<=randomHolePosition[39] && randomHolePosition[39]<=110) &  yPos > 455) || ((0<=randomHolePosition[40] && randomHolePosition[40]<=110) &  yPos > 455) || ((0<=randomHolePosition[41] && randomHolePosition[41]<=110) &  yPos > 455) || ((0<=randomHolePosition[42] && randomHolePosition[42]<=110) &  yPos > 455) || ((0<=randomHolePosition[43] && randomHolePosition[43]<=110) &  yPos > 455) || ((0<=randomHolePosition[44] && randomHolePosition[44]<=110) &  yPos > 455) || ((0<=randomHolePosition[45] && randomHolePosition[45]<=110) &  yPos > 455) || ((0<=randomHolePosition[46] && randomHolePosition[46]<=110) &  yPos > 455) || ((0<=randomHolePosition[47] && randomHolePosition[47]<=110) &  yPos > 455) || ((0<=randomHolePosition[48] && randomHolePosition[48]<=110) &  yPos > 455) || ((0<=randomHolePosition[49] && randomHolePosition[49]<=110) &  yPos > 455)) {       
    textSize(60);
    fill(127,0,0);
    text("GAME OVER!", 400, 300);
    textSize(32);
    fill(0,0,127);
    text("Move your fist/palm to restart", 350, 340);  
    gameOver = true;
    draw();
  }  
...
void keyPressed() {
  ...
  if((didUserChooseMovementDetectorType==false && key == '1') ||(didUserChooseMovementDetectorType==false && key == '3') )  {   
    userChoiseForMovementDetectorType=1;     
  }
  else if(didUserChooseMovementDetectorType==false && key == '2' || (didUserChooseMovementDetectorType==false && key == '4'))  {   
  ...
  myMario = new Mario(50,455);
    }else{
        marioimage = loadImage("Wing_Peach.png");
  marioimage.resize(80,80);
...
public class HandMovementDetector extends PApplet {
  ...
  void setup() { 
      if(userChoiseForMovementDetectorType == 1 || userChoiseForMovementDetectorType == 3){
      userCharacter=1;
    }else{
      userCharacter=2;
    }
  ...
  void draw() {
    ...
    if(gameOver == true){
     ...
     //println(faces[i].x + "," + faces[i].y);
      ...
      if(faces[i].y>0 && (faces[i].y+faces[i].height)<=320 && faces[i].x+faces[i].width<=50) {               
        if (xPos >= 0) {      
          handDetectionPositive=true;
          gameOver = false;
           initialization();
        }}    
      else if(faces[i].y>0 && (faces[i].y+faces[i].height)<=320 && faces[i].x<=50) {        
        if (xPos >= 0) {
          handDetectionPositive=true;
          gameOver = false;
           initialization();
